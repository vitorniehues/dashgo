...
const createUserFormSchema = yup.object().shape({
  ...
  role: yup.string().required('Grupo do usuário obrigatório'),
  cpf: yup.string().required('CPF obrigatório').test('test-cpf', 'CPF inválido', (cpf) => !isCPF(cpf)),
  pessoasAutorizadas: yup.array(yup.number()).nullable()
})
